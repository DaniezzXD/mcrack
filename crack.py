...
def keluar():
    print "Terimakasih sudah pakai tools saya ^_^"
    os.sys.exit()
def acak(x):
    w = 'mhkbpcP'
    d = ''
...
def tokenz():
    ...
    try:
        ...
        print "[!] Token Mungkin Salah/Kadaluarsa"
        time.sleep(1.7)
        masuk()
...
def user_id():
    ...
    print logo
    print 50* "─"
    print "Masukkan username , \ncontoh :www.facebook.com/adam.syukri.31/hanya masukkan (Bams.alay) nya saja, tanpa tanda kurung"
